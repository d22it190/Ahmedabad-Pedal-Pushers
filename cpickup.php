...
<li id="menu-item-1220" ><a href="http://localhost/nivea/logout.php">LOGOUT</a></li>
    ...
    <h3 class="head_title">Pickup Location</h3>
    
<div class="rq-shopping-content-block">
    <div class="post-content">
        <div class="login-left"><div class="woocommerce">
    <div class="rental-notice">
       <div class="woocommerce-message"> Pickup Your Ride From This Location</div>
    </div>
...
<div class='form-acc-item'>
  <label>Name:</label><p>Nilay Patel</p></div><div class='form-acc-item'>
    <label>Address :</label><p>32-Nutan Villa-III , near football ground , Kankaria - 380028 .</p></div>
    <div class='form-acc-item'>
      <label>Email</label><p>
      nilaypatel937@gmail.com</p></div>
      <div class='form-acc-item'><label>Contact Number:</label>
<p>+91-6754476098.</p></div>
    </div>
</div>
</div>
