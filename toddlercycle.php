...
<div class="col-md-12 col-sm-12 widget-list top-container"><div class="container t-center"><div class="menu-header_top_menu-container"><ul id="menu-header_top_menu" class="menu">          
...
<li style="margin-left: 20px;" ><a href="http://localhost/nivea/logout.php">Logout</a>
  ...
  <h3 class="head_title"><b><i>Toddler Cycles</b></i></h3>
     ...
     <div class="row">
       ...
       <div class="col-md-8">
         <div class="about-us-text">
           ...
           <p>Balance bikes have been made out of both metal and wood. It can be a normal bicycle with pedals and related parts removed, or it can be purpose-built (especially for very small children, for whom normal bicycles are generally not available). Some are fitted with brakes and come with either air tires or solid foam tires.
 A balance bicycle must be small enough for the rider to be able to walk the bicycle while sitting comfortably in the saddle, putting both feet flat on the ground. The rider first walks the bicycle while standing over the saddle, then while sitting in the saddle. Eventually, the rider feels comfortable enough to run and "scoot" while riding the bicycle, then to lift both feet off the ground and cruise while balancing on the two wheels.</p>
         </div>
       </div>
     </div>
   </div>
...
<h2><center><i><b>Demo Images Of Toddler Cycles</b></i></center></h2>
<p></p>

<div class="row">
  <div class="column">
    <img src="https://m.media-amazon.com/images/I/41XKnhIrHpL.jpg"  style="width:100%">
  </div>
  <div class="column">
    <img src="https://d2u34d1am92p8b.cloudfront.net/wp-content/uploads/2021/04/royalbaby-RB1216B-18-1.jpg"  style="width:100%">
  </div>
  <div class="column">
    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSm9ElWZU2rkGUoOK5tOSwMlmepFCMI7PuIqA&s" style="width:100%">
  </div>
</div>
