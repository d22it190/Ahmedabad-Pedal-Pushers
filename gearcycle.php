...
<li style="margin-left: 20px;" ><a href="http://localhost/nivea/logout.php">Logout</a>
  ...
  <h3 class="head_title"><b><i>Gear Cycles</b></i></h3>
     ...
     <div class="row">
       ...
       <div class="col-md-8">
         <div class="about-us-text">
           ...
           <p>Most geared bikes have one, two, or three chainrings in the front (the rings attached to the pedal crank arm) and anywhere from seven to 12 gears—or cogs—in the back (the cassette attached to the rear wheel). Moving the chain from the smallest rear cog to the largest eases your pedaling effort incrementally.Gear Cycles are not usually used by everyone due to its complex features and its hard to interact , It is usually ridden by the teenagers of the generation.</p>
         </div>
       </div>
     </div>
   </div>
...
<h2><center><i><b>Demo Images Of Gear Cycles</b></i></center></h2>
<p></p>

<div class="row">
  <div class="column">
    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRc6BiUGaGotID471Oe1kZRPyP_SXK-M6R2lQ&s"  style="width:100%">
  </div>
  <div class="column">
    <img src="https://i5.walmartimages.com/asr/3654f3a2-32fe-427c-9ca2-80cd0a95ff7f.499ca2cf84de506d909719103c338b1f.jpeg"  style="width:100%">
  </div>
  <div class="column">
    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTrWc_bwct9sm-WmxnjVvnndm9Pd09SSmIbXw&s" style="width:100%">
  </div>
</div>
